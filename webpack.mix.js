...
/*
 ...
 | -----------------------------------------------
 | Using your view with mix('css/goaffpro.css', 'vendor/goaffpro')
...
// mix
    // .postCss('resources/css/goaffpro.css', 'css', [require('tailwindcss')('tailwind.config.js')])
    // .js('resources/js/goaffpro.js', 'js')
    // .version()
